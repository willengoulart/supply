 ...
 * @property \App\Model\Table\PromocoesTable|\Cake\ORM\Association\BelongsTo $Promocoes
 *
...
class ProdutosTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Promocoes', [
            'foreignKey' => 'promocoes_id',
            'joinType' => 'INNER'
        ]);
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('qtdEstoque')
            ->requirePresence('qtdEstoque', 'create')
            ->notEmpty('qtdEstoque');
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['promocoes_id'], 'Promocoes'));
